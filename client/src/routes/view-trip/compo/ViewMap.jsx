...
const ViewMap = ({ trip }) => {
  ...
  return (
    <div>
      <div style={{ width: "100%", height: "450px" }} ref={mapContainerRef}></div>
      <div className="flex justify-around mb-4">
        <button
        className={`px-6 py-3 rounded-lg shadow-lg font-bold text-white transition-transform duration-300 transform ${
