  ...
  console.log("Animations:", animations);
   ...
   useEffect(() => {
      if (actions?.Object_0) {
        ...
        console.warn("Animation 'Object_0' לא קיימת.");
      }
    }, [actions]);
                  ...
                  <group name="Object_137" position={[0.77, 11.67, 1.19]} rotation={[-1.31, 0, 0]}>
                    <group name="TimeframeMainGroup_20">
                      <group name="Object_139">
                        <mesh name="Cylinder002_23_0" geometry={nodes.Cylinder002_23_0.geometry} material={materials.Cylinder001} />
                      </group>
                    </group>
                    <group name="TimeframeMainGroup_21">
                      <group name="Object_142">
                        <mesh name="Cylinder002_23_0_1" geometry={nodes.Cylinder002_23_0_1.geometry} material={materials.Cylinder001} />
                      </group>
                    </group>
                  </group>
